...
En esta sección nos proponemos el aplicar el contexto teórico visto hasta ahora al análisis del cambio climático. Para ello principalmente utilizaremos el paquete de R: "mgcv" (siglas en inglés de "Vehículo de Computación para MAG Mixtos")
