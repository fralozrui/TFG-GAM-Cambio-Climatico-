...
csl: acm-sig-proceedings-long-author-list.csl      # no numera mejor en las citas
...
---
nocite: | 
  @Luque2017, @Wood, @Hastie, @M-Clark, @MLG-wikipedia, @fundamentos, @Stat-Learning, @CursoMNP, @consenso, @desinfo, @CAAD, @OficinaCC, @consecuencias
...
