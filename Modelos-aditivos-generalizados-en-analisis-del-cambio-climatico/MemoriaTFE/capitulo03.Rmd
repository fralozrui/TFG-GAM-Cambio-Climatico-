...
```{r}
# Definir la función lineal por partes
b1 <- function(x) {
  ifelse(x < 1, 1-x, 0)
}
...
y2 <- b2(x)
y5 <- b5(x)
# Dividir el espacio de la gráfica en 1 fila y 3 columnas
par(mfrow = c(1, 3))

# Graficar la función lineal por partes
plot(x, y1, type = "l", col = "blue", main = "Función Lineal por Partes b1(x)")
plot(x, y2, type = "l", col = "blue", main = "Función Lineal por Partes b2(x)")
plot(x, y5, type = "l", col = "blue", main = "Función Lineal por Partes b5(x)")
